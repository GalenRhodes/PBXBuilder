...
typedef NS_ENUM(NSInteger, PBXErrorCodes) {
    PBX_NO_ERROR = 0, PBX_INVALID_REGEX_PATTERN, PBX_UNKNOWN_CMDLINE_OPTION, PBX_NO_PROJECT_FILE_FOUND, PBX_MULTIPLE_PROJECT_FILES_FOUND, PBX_INVALID_PROJECT_FILENAME
};
